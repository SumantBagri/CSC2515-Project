...
from gbdt_uncertainty.training import tune_parameters_regression, generate_ensemble_regression, \
    tune_parameters_classification, generate_ensemble_classification, generate_rf_ensemble_regression, \
    generate_rf_ensemble_classification
import os
...
if mode == "classification":
    ...
    datasets = ["internet"] #["adult", "amazon", "click", "internet", 
